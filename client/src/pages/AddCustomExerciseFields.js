...
// Queries
import addCustomExerciseField from '../queries/addCustomExerciseField'
import deleteCustomExerciseField from '../queries/deleteCustomExerciseField'
...
function AddCustomExerciseFields(props) {
  ...
  const handleSubmit = (e) => {
    ...
    .then(
      ({ data: { addCustomExerciseField: { name } } }) => {
        M.toast({
  ...
  const handleRemove = id => {
    props.deleteCustomExerciseField({
      variables: { id },
    })
    .then(
      ({ data: { deleteCustomExerciseField: { name } }}) => {
        M.toast({
