...
const Routes = () => {
  ...
  <>
    ...
    <Route path="/create/program"
      render={ () => <CreateProgram userId={userId}/> }
    />
    
    <Route path="/create/setup" 
      render={ () => <SetupWorkout userId={userId}/> }
    />

    <Route path="/create/workout/:id"
      render={ () => <CreateWorkout userId={userId}/> }
    />
    
    <Route path="/create/exercise" 
      render={ () => <CreateExercise userId={userId}/> }
    />

    <Route path="/customize_exercise/:id"
      render={ () => <AddCustomExerciseFields userId={userId}/> }
    />

    <Route path="/create/set" 
      render={ () => <CreateSet userId={userId}/> }
    />

    <Route exact path="/workouts"
      render={ () => <AllWorkouts userId={userId}/> }
    />

    <Route path="/workouts/calendar"
